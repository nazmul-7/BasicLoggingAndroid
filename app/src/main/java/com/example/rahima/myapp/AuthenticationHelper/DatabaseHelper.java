...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + "(Id INTEGER PRIMARY KEY AUTOINCREMENT,"+USERNAME+" TEXT ,"+PASSWORD+" TEXT ,"+LEVEL_1+" INTEGER ,"+LEVEL_2+" INTEGER ,"+LEVEL_3+" INTEGER )";
